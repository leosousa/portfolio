...
/*==================== multiple language js ====================*/
// const langObject = document.getElementById('linguagem');
...
async function fetchLanguageData(lang) {
  ...
  /*==================== toggle language config ====================*/
let languageConfig = document.querySelector('#language-config');
...
languageConfig.onclick = () => {
  ...
  window.addEventListener('DOMContentLoaded', async () => {
    ...
    if (userPreferredLanguage == 'pt-br') {
        languageConfig.classList.add('fi-us');
    }else {
        languageConfig.classList.add('fi-br');
    }
  });